...
add_filter( 'rwmb_meta_boxes' , 'register_blocks' , 10 , 1 );

/**
 * add a filter to the default preview setting
 * if
 */
add_filter( 'timber/mb-gutenberg-blocks-preview' , 'default_preview_on_empty' );
 ...
 */
add_filter( 'timber/mb-gutenberg-blocks-fields' , 'default_fields_on_empty' );

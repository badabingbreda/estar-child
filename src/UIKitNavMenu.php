<?php
	/**
	 *
	 *	https://gist.github.com/Dreamelf/d63b2a6a05236e66f31ee46e7f4d4482
	 *
	...
	*/
	...
	/**
		* Offcanvas menu
	*/
	function uikit_modal_menu( $menu_name ) { ?>
						<?php
							wp_nav_menu( array(
							'menu'              => $menu_name,
							'depth'             => 2,
							'container'         => 'ul',
							'items_wrap'        => '<ul id="%1$s" class="%2$s" uk-nav>%3$s</ul>',
							'menu_class'        => 'uk-text-large uk-nav uk-navbar-dropdown-nav',
							'fallback_cb'       => 'uikit_offcanvas_w_menu::fallback',
							'walker'            => new uikit_offcanvas_w_menu()
						)); ?>
	<?php }
	...
	/**
		* Top menu
	*/
	function uikit_top_menu( $menu_name ) {
